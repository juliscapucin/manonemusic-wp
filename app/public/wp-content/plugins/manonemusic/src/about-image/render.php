...
<div class="md:absolute -top-[--header-height] w-screen md:h-[--container-height-desktop] max-w-wide mx-auto flex justify-center items-center -z-10">
   <div class="w-full md:w-96 aspect-square relative overflow-clip">
